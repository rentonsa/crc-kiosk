...
// hack around with the require_once paths a bit so the library 'just works'
...
// require_once the top level classes, they each require_once their own dependencies
...
class Google_Client {
  ...
  /**
   * @param string $accessType Possible values for access_type require_once:
  ...
  /**
   * @param string $approvalPrompt Possible values for approval_prompt require_once:
  ...
  /**
   * Set the application name, this is require_onced in the User-Agent HTTP header.
